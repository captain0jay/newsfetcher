...
export default class App extends Component {
  ...
  render() {
    ...
    return (
      ...
      />
        <Switch>
        <Route exact path="/"><News setProgress={this.setProgress} key={1} pageSize={8} country="in" category="general"/></Route>
        <Route exact path="/business"><News setProgress={this.setProgress} key={2} pageSize={8} country="in" category="business"/></Route>
